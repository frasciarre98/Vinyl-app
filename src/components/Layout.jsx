        ...
        <div className="min-h-[100dvh] flex flex-col w-full overflow-x-hidden relative">
                ...
                <div className="container mx-auto px-4 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="text-2xl font-black tracking-wider text-slate-900 uppercase italic">
                            Vinyl <span className="text-slate-600 font-bold">Catalog V37.0</span>
                        </h1>
                    </div>
            ...
            <footer className="border-t border-border py-6 mt-4">
                <div className="container mx-auto px-4 text-center text-white/40 text-sm">
                    <p>© {new Date().getFullYear()} Vinyl Catalog. Audiophile Grade. <span className="opacity-90 font-bold text-white/60 text-xs">v37.0-ZENITH</span></p>
                </div>
            </footer>
        </div >
    );
